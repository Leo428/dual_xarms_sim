...
_XML = _HERE / "ufactory_xarm7" / "insert_scene_yam.xml"
...
def main():
    ...
    # Define tasks
    r_end_effector_task = mink.FrameTask(
    ...
    tasks = [r_end_effector_task, posture_task]
    ...
    with mujoco.viewer.launch_passive(
        ...
        while viewer.is_running():
            ...
            r_end_effector_task.set_target(T_wt)
