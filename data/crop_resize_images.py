...
def process_camera_images(image_dataset, episode_length, center_crop, resize):
    """
    ...
    cropped_resized_frames = center_crop(cropped_resized_frames)
...
if __name__ == "__main__":
    ...
    # Define transforms
    center_crop = CenterCrop((360, 360))
            ...
            with h5py.File(filename, "r") as src:
                ...
                with h5py.File(new_filename, "w") as dst:
                    ...
                    for cam_name in tqdm(camera_names, desc="Processing Cameras", leave=False):
                        ...
                        processed_images = process_camera_images(image_dataset, episode_length, center_crop, resize)
