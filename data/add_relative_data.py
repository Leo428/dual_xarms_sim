    ...
    for filename in tqdm(hdf5_files):
        try:
            ...
            with h5py.File(filename, "r+") as root:
                ...
                left_ee_pose = root["obses/state/left/ee_pose"][()]
                right_ee_pose = root["obses/state/right/ee_pose"][()]
                left_ee_vel = root["obses/state/left/ee_vel"][()]
                right_ee_vel = root["obses/state/right/ee_vel"][()]
